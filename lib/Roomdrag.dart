...
class Roomdrag extends StatelessWidget {
  @override
...
class _InteriorDesignScreenState extends State<InteriorDesignScreen> {
  Map<String, List<Furniture>> furnitureCategories = {
    'Bed': [
      Furniture('', 'Assets/Images/bed.jpeg'),
      Furniture('', 'Assets/Images/bed2.jpeg'),
    ],
    'Chair': [
      Furniture('', 'Assets/Images/chair5.jpg'),
      Furniture('', 'Assets/Images/chair6.png'),
    ],
    'Lamp': [
      Furniture('', 'Assets/Images/lamp5.jpeg'),
      Furniture('', 'Assets/Images/lampBR.jpeg'),
    ],
    'Flowerpot table': [
      Furniture('', 'Assets/Images/potstand1.jpeg'),
      Furniture('', 'Assets/Images/potstand2.jpeg'),
    ],
