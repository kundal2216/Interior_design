...
class Michael extends StatefulWidget {
  const Michael({super.key});
...
class _DetailPageState extends State<Michael> {
  @override
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("Assets/Images/LR1.jpg"),
                  fit: BoxFit.cover),
            ),
            child: SafeArea(
              child: Padding(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/LR2.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/LR3.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/LR4.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        )
                      ],
