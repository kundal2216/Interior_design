...
class Phillipe extends StatefulWidget {
  const Phillipe({super.key});
...
class _DetailPageState extends State<Phillipe> {
  @override
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/K2.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/K3.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              image: const DecorationImage(image: AssetImage("Assets/Images/K4.jpg"),fit: BoxFit.cover)
                            ),
                          ),
                        )
                      ],
