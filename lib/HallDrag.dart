...
class _InteriorDesignScreenState extends State<InteriorDesignScreen> {
  Map<String, List<Furniture>> furnitureCategories = {
    ...
    'vase': [
      Furniture('', 'Assets/Images/vase.jpg'),
      Furniture('', 'Assets/Images/Vase2.png'),
    ],
    'Tv': [
      Furniture('', 'Assets/Images/tv.jpg'),
      Furniture('', 'Assets/Images/tv2.jpg'),
    ],
    'bed': [
      Furniture('', 'Assets/Images/bed1.jpg'),
      Furniture('', 'Assets/Images/bed2.jpg'),
    ],
